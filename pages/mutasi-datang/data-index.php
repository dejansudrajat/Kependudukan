...
$query = "SELECT *,nik_warga,nama_warga,jenis_kelamin_warga,pendidikan_terakhir_warga,pekerjaan_warga, status_warga, TIMESTAMPDIFF(YEAR, `tanggal_lahir_warga`, CURDATE()) AS usia_mutasi FROM warga JOIN mutasi_masuk ON warga.id_warga = mutasi_masuk.id_warga";
