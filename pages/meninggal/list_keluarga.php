...
//ambil warga
 $query_warga = "SELECT nama_warga,nik_warga,id_warga FROM warga WHERE status_warga<>'Meninggal'";
# $query_warga = "SELECT warga.nama_warga, warga.nik_warga, warga.id_warga FROM warga JOIN tbl_meninggal WHERE warga.id_warga<>tbl_meninggal.id_warga";
