...
//ambil data kk
$query_keluarga = "SELECT warga.nama_warga, kartu_keluarga.id_keluarga, kartu_keluarga.nomor_keluarga, kartu_keluarga.alamat_keluarga, warga.desa_kelurahan_warga, warga.dusun_warga, warga.rt_warga, warga.rw_warga FROM warga JOIN kartu_keluarga ON warga.id_warga=kartu_keluarga.id_kepala_keluarga ";
