...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 29, 2017 at 10:31 AM
...
(23, '2017-12-29 00:00:00', 'Baim', 'L', '3', 50, 'dejan', 'entah', 'Bukan Rumah Bersalin', 'kuningan', 13, 'Bidan cantik', 11, 0);
...
(11, 'Administrator', 'admin_dukuhdalem', '0192023a7bbd73250516f069df18b500', '', 'Admin', 'Dukuhdalem', 'Ciawigebang', 'Kuningan', 'Jawa Barat', 'Indonesia', '-', '-', '2017-12-15 04:30:43', '2017-12-15 04:30:43');
...
--
ALTER TABLE `tbl_kelahiran`
  MODIFY `id_kelahiran` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
